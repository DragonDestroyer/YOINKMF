...
const milestoneBaseData = {
    ...
    "Angry Heroes": { name: "Angry Heroes", expense: 50000000, tier: 14, description: "Hero XP, 10x faster Faint Hope", effect: 1e15 },
    "Tired Heroes": { name: "Tired Heroes", expense: 100000000, tier: 15, description: "Hero XP", effect: 1e15 },
    "Scared Heroes": { name: "Scared Heroes", expense: 150000000, tier: 16, description: "Hero XP, new Evil Perk", effect: 1e15 },
    ...
    "The End is near": { name: "The End is near", expense: 1e150, tier: 50, description: "Unspent Multiverse Perk Points buffs Dark Matter" },
